        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (child.getLayoutParams().width == -1) {
                    child.measure(View.MeasureSpec.makeMeasureSpec(availableWidth, CrashUtils.ErrorDialogData.SUPPRESSED), View.MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), CrashUtils.ErrorDialogData.SUPPRESSED));
                }
            }
        }
    }
