...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mode == 0 && topInset > 0) {
            super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() + topInset, CrashUtils.ErrorDialogData.SUPPRESSED));
        }
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.mCollapsingTitleEnabled && this.mDummyView != null) {
            ...
            if (this.mDrawCollapsingTitle) {
                ...
                this.mCollapsingTextHelper.setCollapsedBounds(this.mTmpRect.left + (isRtl ? this.mToolbar.getTitleMarginEnd() : this.mToolbar.getTitleMarginStart()), this.mTmpRect.top + maxOffset + this.mToolbar.getTitleMarginTop(), this.mTmpRect.right + (isRtl ? this.mToolbar.getTitleMarginStart() : this.mToolbar.getTitleMarginEnd()), (this.mTmpRect.bottom + maxOffset) - this.mToolbar.getTitleMarginBottom());
    ...
    public void setScrimVisibleHeightTrigger(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int height) {
    ...
    public void setScrimAnimationDuration(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) long duration) {
