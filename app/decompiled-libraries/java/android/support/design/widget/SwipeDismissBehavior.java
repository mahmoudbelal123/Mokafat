        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            ...
            if (SwipeDismissBehavior.this.mSwipeDirection == 0) {
                ...
                if (isRtl) {
                    ...
                    int min2 = this.mOriginalCapturedViewLeft;
                    min = min2 - child.getWidth();
                    max = this.mOriginalCapturedViewLeft;
                }
            } else {
                int min3 = this.mOriginalCapturedViewLeft;
    ...
    */
    public boolean onInterceptTouchEvent(android.support.design.widget.CoordinatorLayout r5, V r6, android.view.MotionEvent r7) {
        ...
        L24:
            ...
            android.support.v4.widget.ViewDragHelper r1 = r4.mViewDragHelper
    ...
    private void ensureViewDragHelper(ViewGroup parent) {
        ...
        if (this.mViewDragHelper == null) {
            if (this.mSensitivitySet) {
                viewDragHelperCreate = ViewDragHelper.create(parent, this.mSensitivity, this.mDragCallback);
            } else {
                viewDragHelperCreate = ViewDragHelper.create(parent, this.mDragCallback);
            }
