...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup sceneRoot, View view, View parent) {
        ...
        int widthSpec = View.MeasureSpec.makeMeasureSpec(right - left, CrashUtils.ErrorDialogData.SUPPRESSED);
        int heightSpec = View.MeasureSpec.makeMeasureSpec(bottom - top, CrashUtils.ErrorDialogData.SUPPRESSED);
