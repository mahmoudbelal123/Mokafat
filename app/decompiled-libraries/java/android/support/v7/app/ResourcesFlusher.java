...
class ResourcesFlusher {
    ...
    @RequiresApi(23)
    private static boolean flushMarshmallows(@NonNull Resources resources) throws IllegalAccessException {
        if (!sDrawableCacheFieldFetched) {
            try {
                sDrawableCacheField = Resources.class.getDeclaredField("mDrawableCache");
                sDrawableCacheField.setAccessible(true);
    ...
    @RequiresApi(24)
    private static boolean flushNougats(@NonNull Resources resources) throws IllegalAccessException {
