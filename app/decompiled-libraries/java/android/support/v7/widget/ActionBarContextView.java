...
public class ActionBarContextView extends AbsActionBarView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mCustomView != null) {
            ...
            int customWidthMode = lp2.width != -2 ? CrashUtils.ErrorDialogData.SUPPRESSED : Integer.MIN_VALUE;
            int customWidth = lp2.width >= 0 ? Math.min(lp2.width, availableWidth) : availableWidth;
            int customHeightMode = lp2.height != -2 ? CrashUtils.ErrorDialogData.SUPPRESSED : Integer.MIN_VALUE;
