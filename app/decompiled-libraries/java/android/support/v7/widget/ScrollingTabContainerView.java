...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, CrashUtils.ErrorDialogData.SUPPRESSED);
    ...
    private class TabView extends LinearLayout {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > ScrollingTabContainerView.this.mMaxTabWidth) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, CrashUtils.ErrorDialogData.SUPPRESSED), heightMeasureSpec);
            }
        }
