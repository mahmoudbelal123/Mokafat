    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        if (flexibleInOtherDir) {
            ...
            for (int maxSize4 = 0; maxSize4 < count2; maxSize4++) {
                ...
                measureChild(view3, CrashUtils.ErrorDialogData.SUPPRESSED, true);
        ...
        while (i3 < count2) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view4) != maxSize) {
                ...
                if (this.mOrientation == 1) {
                    ...
                    wSpec = getChildMeasureSpec(totalSpaceInOther, CrashUtils.ErrorDialogData.SUPPRESSED, horizontalInsets, lp.width, false);
                    hSpec = View.MeasureSpec.makeMeasureSpec(maxSize - verticalInsets, CrashUtils.ErrorDialogData.SUPPRESSED);
                } else {
                    remainingSpan = remainingSpan3;
                    wSpec = View.MeasureSpec.makeMeasureSpec(maxSize - horizontalInsets, CrashUtils.ErrorDialogData.SUPPRESSED);
                    hSpec = getChildMeasureSpec(totalSpaceInOther, CrashUtils.ErrorDialogData.SUPPRESSED, verticalInsets, lp.height, false);
                }
