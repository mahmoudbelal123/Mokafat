    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long currentTime) {
            ...
            if (this.mStopTime < 0 || currentTime < this.mStopTime) {
                ...
                return 0.5f * AutoScrollHelper.constrain(elapsedSinceStart / this.mRampUpDuration, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY);
            }
            long elapsedSinceEnd = currentTime - this.mStopTime;
            return (AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY - this.mStopValue) + (this.mStopValue * AutoScrollHelper.constrain(elapsedSinceEnd / this.mEffectiveRampDown, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY));
        }
