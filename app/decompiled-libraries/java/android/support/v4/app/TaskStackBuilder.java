...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    @NonNull
    public TaskStackBuilder addNextIntentWithParentStack(@NonNull Intent nextIntent) throws PackageManager.NameNotFoundException {
    ...
    @NonNull
    public TaskStackBuilder addParentStack(@NonNull Activity activity) throws PackageManager.NameNotFoundException {
        Intent parent = null;
    ...
    public void startActivities(@Nullable Bundle options) {
        ...
        if (!ContextCompat.startActivities(this.mSourceContext, intents, options)) {
            ...
            topIntent.addFlags(CrashUtils.ErrorDialogData.BINDER_CRASH);
