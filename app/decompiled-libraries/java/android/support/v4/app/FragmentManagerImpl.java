...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    */
    ...
    void saveNonConfig() {
        ...
        if (this.mActive != null) {
            ArrayList<FragmentManagerNonConfig> arrayList = null;
            ...
            for (int i = 0; i < this.mActive.size(); i++) {
                ...
                if (f != null) {
                    ...
                    if (arrayList == null && f.mViewModelStore != null) {
                    ...
                    if (arrayList != null) {
                        arrayList.add(f.mViewModelStore);
                    }
                }
            }
            fragments = fragments3;
            fragments2 = arrayList2;
            childFragments = arrayList;
        }
