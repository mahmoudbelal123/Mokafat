...
public final class Cookie {
        ...
        if (!cookieName.isEmpty() && Util.indexOfControlOrNonAscii(cookieName) == -1) {
            ...
            while (pos < limit2) {
                ...
                if (attributeEqualsSign < attributePairEnd) {
                    int pos2 = attributeEqualsSign + 1;
                    attributeValue = Util.trimSubstring(str, pos2, attributePairEnd);
                } else {
                    attributeValue = "";
                }
            ...
            if (deltaSeconds == Long.MIN_VALUE) {
                ...
                long deltaMilliseconds = deltaSeconds <= 9223372036854775L ? 1000 * deltaSeconds : LongCompanionObject.MAX_VALUE;
            ...
            return new Cookie(cookieName, cookieValue, expiresAt, domain, path3, secureOnly, httpOnly, hostOnly, persistent);
        }
        return null;
    }
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * 17) + this.name.hashCode())) + this.value.hashCode())) + this.domain.hashCode())) + this.path.hashCode())) + ((int) (this.expiresAt ^ (this.expiresAt >>> 32))))) + (!this.secure ? 1 : 0))) + (!this.httpOnly ? 1 : 0))) + (!this.persistent ? 1 : 0))) + (!this.hostOnly ? 1 : 0);
    }
}
