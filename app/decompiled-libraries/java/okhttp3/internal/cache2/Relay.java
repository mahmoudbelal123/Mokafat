...
final class Relay {
    ...
    public static Relay edit(File file, Source upstream, ByteString metadata, long bufferMaxSize) throws Throwable {
    ...
    private void writeHeader(ByteString prefix, long upstreamSize, long metadataSize) throws Throwable {
        Buffer header = new Buffer();
        header.write(prefix);
    ...
    private void writeMetadata(long upstreamSize) throws Throwable {
        Buffer metadataBuffer = new Buffer();
    ...
    void commit(long upstreamSize) throws Throwable {
