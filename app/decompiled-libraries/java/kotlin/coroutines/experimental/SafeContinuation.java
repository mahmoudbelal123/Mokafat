...
public final class SafeContinuation<T> implements Continuation<T> {
    ...
    public SafeContinuation(@NotNull Continuation<? super T> delegate) {
        this(delegate, INSTANCE.getUNDECIDED());
        Intrinsics.checkParameterIsNotNull(delegate, "delegate");
    }
    ...
    /* JADX INFO: compiled from: SafeContinuationJvm.kt */
    @Metadata(bv = {1, 0, 1}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0004\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Lkotlin/coroutines/experimental/SafeContinuation$Fail;", "", "exception", "", "(Ljava/lang/Throwable;)V", "getException", "()Ljava/lang/Throwable;", "kotlin-stdlib"}, k = 1, mv = {1, 1, 5})
    ...
    public void resume(T value) {
        while (true) {
            ...
            if (result == INSTANCE.getUNDECIDED()) {
                if (INSTANCE.getRESULT().compareAndSet(this, INSTANCE.getUNDECIDED(), value)) {
                    return;
                }
            } else if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                if (INSTANCE.getRESULT().compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), INSTANCE.getRESUMED())) {
    ...
    public void resumeWithException(@NotNull Throwable exception) {
        ...
        while (true) {
            Object result = this.result;
            if (result == INSTANCE.getUNDECIDED()) {
                if (INSTANCE.getRESULT().compareAndSet(this, INSTANCE.getUNDECIDED(), new Fail(exception))) {
                    return;
                }
            } else if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                if (INSTANCE.getRESULT().compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), INSTANCE.getRESUMED())) {
    ...
    public final Object getResult() throws Throwable {
        Object result = this.result;
        if (result == INSTANCE.getUNDECIDED()) {
            if (INSTANCE.getRESULT().compareAndSet(this, INSTANCE.getUNDECIDED(), IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
                return IntrinsicsKt.getCOROUTINE_SUSPENDED();
            }
            result = this.result;
        }
        if (result == INSTANCE.getRESUMED()) {
            return IntrinsicsKt.getCOROUTINE_SUSPENDED();
        }
