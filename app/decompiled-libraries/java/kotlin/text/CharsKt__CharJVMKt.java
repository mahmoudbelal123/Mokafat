...
class CharsKt__CharJVMKt {
    ...
    public static final CharCategory getCategory(char $receiver) {
        return CharCategory.INSTANCE.valueOf(Character.getType($receiver));
    }

    @NotNull
    public static final CharDirectionality getDirectionality(char $receiver) {
        return CharDirectionality.INSTANCE.valueOf(Character.getDirectionality($receiver));
    }
