...
public class CollectionsKt__MutableCollectionsKt extends CollectionsKt__IteratorsKt {
    ...
    public static final <T> boolean removeAll(@NotNull Collection<? super T> receiver, @NotNull Iterable<? extends T> elements) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(elements, "elements");
        Collection<?> collectionConvertToSetForSetOperationWith = CollectionsKt.convertToSetForSetOperationWith(elements, receiver);
        if (receiver == null) {
            throw new TypeCastException("null cannot be cast to non-null type kotlin.collections.MutableCollection<T>");
        }
        return TypeIntrinsics.asMutableCollection(receiver).removeAll(collectionConvertToSetForSetOperationWith);
    }
    ...
    public static final <T> boolean retainAll(@NotNull Collection<? super T> receiver, @NotNull Iterable<? extends T> elements) {
        ...
        return TypeIntrinsics.asMutableCollection(receiver).retainAll(collectionConvertToSetForSetOperationWith);
    }
