...
public class RequestOptions implements Cloneable {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions overrideOf(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int width, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int height) {
        return new RequestOptions().override(width, height);
    }

    @CheckResult
    @NonNull
    public static RequestOptions overrideOf(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int size) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions frameOf(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) long frameTimeMicros) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions timeoutOf(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int timeout) {
        return new RequestOptions().timeout(timeout);
    }

    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 100) int quality) {
    ...
    public RequestOptions sizeMultiplier(@FloatRange(from = 0.0d, to = 1.0d) float sizeMultiplier) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().sizeMultiplier(sizeMultiplier);
        }
    ...
    public RequestOptions useUnlimitedSourceGeneratorsPool(boolean flag) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().useUnlimitedSourceGeneratorsPool(flag);
        }
    ...
    public RequestOptions useAnimationPool(boolean flag) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().useAnimationPool(flag);
        }
    ...
    public RequestOptions onlyRetrieveFromCache(boolean flag) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().onlyRetrieveFromCache(flag);
        }
    ...
    public RequestOptions diskCacheStrategy(@NonNull DiskCacheStrategy strategy) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().diskCacheStrategy(strategy);
        }
    ...
    public RequestOptions placeholder(@DrawableRes int resourceId) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().placeholder(resourceId);
        }
    ...
    public RequestOptions fallback(@DrawableRes int resourceId) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().fallback(resourceId);
        }
    ...
    public RequestOptions error(@DrawableRes int resourceId) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().error(resourceId);
        }
    ...
    public RequestOptions override(int width, int height) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().override(width, height);
        }
    ...
    public RequestOptions signature(@NonNull Key signature) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().signature(signature);
        }
    ...
    public <T> RequestOptions set(@NonNull Option<T> option, @NonNull T value) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().set(option, value);
        }
    ...
    public RequestOptions decode(@NonNull Class<?> resourceClass) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().decode(resourceClass);
        }
    ...
    @CheckResult
    @NonNull
    public RequestOptions encodeQuality(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 100) int quality) {
        return set(BitmapEncoder.COMPRESSION_QUALITY, Integer.valueOf(quality));
    }

    @CheckResult
    @NonNull
    public RequestOptions frame(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) long frameTimeMicros) {
    ...
    @CheckResult
    @NonNull
    public RequestOptions timeout(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int timeoutMs) {
    ...
    final RequestOptions optionalTransform(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().optionalTransform(downsampleStrategy, transformation);
        }
    ...
    final RequestOptions transform(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().transform(downsampleStrategy, transformation);
        }
        downsample(downsampleStrategy);
    ...
    private RequestOptions transform(@NonNull Transformation<Bitmap> transformation, boolean isRequired) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().transform(transformation, isRequired);
        }
    ...
    private <T> RequestOptions transform(@NonNull Class<T> resourceClass, @NonNull Transformation<T> transformation, boolean isRequired) {
        if (this.isAutoCloneEnabled) {
            return mo9clone().transform(resourceClass, transformation, isRequired);
        }
