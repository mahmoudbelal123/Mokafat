...
interface zzyw {
    ...
    void zza(int i, zzud zzudVar) throws IOException;

    <K, V> void zza(int i, zzwm<K, V> zzwmVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzxj zzxjVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzxj zzxjVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzxj zzxjVar) throws IOException;

    void zzb(int i, String str) throws IOException;

    void zzb(int i, List<zzud> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzxj zzxjVar) throws IOException;
    ...
    @Deprecated
    void zzbk(int i) throws IOException;
