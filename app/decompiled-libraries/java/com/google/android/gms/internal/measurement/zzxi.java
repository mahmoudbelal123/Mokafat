...
interface zzxi {
    ...
    <T> T zza(zzxj<T> zzxjVar, zzuz zzuzVar) throws IOException;

    <T> void zza(List<T> list, zzxj<T> zzxjVar, zzuz zzuzVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzwm<K, V> zzwmVar, zzuz zzuzVar) throws IOException;

    @Deprecated
    <T> T zzb(zzxj<T> zzxjVar, zzuz zzuzVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzxj<T> zzxjVar, zzuz zzuzVar) throws IOException;
