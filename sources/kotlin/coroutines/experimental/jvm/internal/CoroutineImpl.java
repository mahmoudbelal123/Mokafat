...
public abstract class CoroutineImpl extends Lambda implements Continuation<Object> {
    ...
    public CoroutineImpl(int arity, @Nullable Continuation<Object> continuation) {
        super(arity);
