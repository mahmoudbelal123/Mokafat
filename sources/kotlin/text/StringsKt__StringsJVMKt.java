...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(@NotNull String receiver, char oldChar, char newChar, boolean ignoreCase) {
        ...
        if (ignoreCase) {
            return SequencesKt.joinToString$default(StringsKt.splitToSequence$default(receiver, new char[]{oldChar}, ignoreCase, 0, 4, (Object) null), String.valueOf(newChar), null, null, 0, null, null, 62, null);
        }
        if (receiver == null) {
            throw new TypeCastException("null cannot be cast to non-null type java.lang.String");
        }
        String strReplace = receiver.replace(oldChar, newChar);
    ...
    public static final String replace(@NotNull String receiver, @NotNull String oldValue, @NotNull String newValue, boolean ignoreCase) {
        ...
        return SequencesKt.joinToString$default(StringsKt.splitToSequence$default(receiver, new String[]{oldValue}, ignoreCase, 0, 4, (Object) null), newValue, null, null, 0, null, null, 62, null);
    }
    ...
    public static final String replaceFirst(@NotNull String receiver, char oldChar, char newChar, boolean ignoreCase) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        int index = StringsKt.indexOf$default(receiver, oldChar, 0, ignoreCase, 2, (Object) null);
        if (index < 0) {
            return receiver;
        }
        int i = index + 1;
        String strValueOf = String.valueOf(newChar);
        if (receiver == null) {
            throw new TypeCastException("null cannot be cast to non-null type kotlin.CharSequence");
        }
        return StringsKt.replaceRange((CharSequence) receiver, index, i, (CharSequence) strValueOf).toString();
    }
    ...
    public static final String replaceFirst(@NotNull String receiver, @NotNull String oldValue, @NotNull String newValue, boolean ignoreCase) {
        ...
        Intrinsics.checkParameterIsNotNull(oldValue, "oldValue");
        Intrinsics.checkParameterIsNotNull(newValue, "newValue");
        int index = StringsKt.indexOf$default(receiver, oldValue, 0, ignoreCase, 2, (Object) null);
        if (index < 0) {
            return receiver;
        }
        int length = oldValue.length() + index;
        if (receiver == null) {
            throw new TypeCastException("null cannot be cast to non-null type kotlin.CharSequence");
        }
        return StringsKt.replaceRange((CharSequence) receiver, index, length, (CharSequence) newValue).toString();
    }
    ...
    private static final String format(@NotNull String $receiver, Object... args) {
        String str = String.format($receiver, Arrays.copyOf(args, args.length));
    ...
    private static final String format(@NotNull String $receiver, Locale locale, Object... args) {
        String str = String.format(locale, $receiver, Arrays.copyOf(args, args.length));
    ...
    public static final List<String> split(@NotNull CharSequence receiver, @NotNull Pattern regex, int limit) {
        ...
        if (limit >= 0) {
            return ArraysKt.asList(regex.split(receiver, limit == 0 ? -1 : limit));
        }
    ...
    private static final String substring(@NotNull String $receiver, int startIndex) {
        ...
        String strSubstring = $receiver.substring(startIndex);
    ...
    private static final String substring(@NotNull String $receiver, int startIndex, int endIndex) {
        ...
        String strSubstring = $receiver.substring(startIndex, endIndex);
    ...
    private static final String intern(@NotNull String $receiver) {
        ...
        String strIntern = $receiver.intern();
    ...
    static /* bridge */ /* synthetic */ Pattern toPattern$default(String $receiver, int flags, int i, Object obj) {
        ...
        Pattern patternCompile = Pattern.compile($receiver, flags);
            ...
            default:
                switch (receiver.length()) {
                    case 0:
                        return "";
                    case 1:
                        char cCharValue = Character.valueOf(receiver.charAt(0)).charValue();
                        char[] result$iv = new char[n];
                        int i2 = n - 1;
                        if (i2 >= 0) {
                            while (true) {
                                result$iv[i$iv] = cCharValue;
                                if (i$iv != i2) {
                                    i$iv++;
                                }
                            }
