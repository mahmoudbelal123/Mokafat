...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(width, CrashUtils.ErrorDialogData.SUPPRESSED), View.MeasureSpec.makeMeasureSpec(height, CrashUtils.ErrorDialogData.SUPPRESSED));
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, CrashUtils.ErrorDialogData.SUPPRESSED);
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        ...
        try {
            ...
            String data2 = data;
            Uri dataUri = data2 == null ? null : Uri.parse(data2);
