...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    ...
    private void forceUniformWidth(int count, int heightMeasureSpec) {
        int uniformMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), CrashUtils.ErrorDialogData.SUPPRESSED);
        for (int i = 0; i < count; i++) {
            View child = getVirtualChildAt(i);
    ...
    */
    ...
    private void forceUniformHeight(int count, int widthMeasureSpec) {
        int uniformMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), CrashUtils.ErrorDialogData.SUPPRESSED);
        for (int i = 0; i < count; i++) {
            View child = getVirtualChildAt(i);
            if (child.getVisibility() != 8) {
                LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        while (true) {
            ...
            if (child == null) {
                ...
                majorGravity = majorGravity2;
                if (gravity2 != 1) {
                    childLeft = gravity2 != 5 ? lp.leftMargin + paddingLeft2 : (childRight - childWidth) - lp.rightMargin;
                } else {
