...
public class ContentFrameLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            if (tvw != null && tvw.type != 0) {
                ...
                if (w > 0) {
                    ...
                    widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(w2, widthSize), CrashUtils.ErrorDialogData.SUPPRESSED);
                    fixedWidth = true;
                }
            }
        }
        if (heightMode == Integer.MIN_VALUE) {
            ...
            if (tvh != null && tvh.type != 0) {
                ...
                if (h > 0) {
                    ...
                    heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(h2, heightSize), CrashUtils.ErrorDialogData.SUPPRESSED);
                }
            }
        }
        ...
        int widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(width, CrashUtils.ErrorDialogData.SUPPRESSED);
        if (!fixedWidth && widthMode == Integer.MIN_VALUE) {
            ...
            if (tv != null && tv.type != 0) {
                ...
                if (width < min) {
                    widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(min, CrashUtils.ErrorDialogData.SUPPRESSED);
                    measure = true;
                }
            }
        }
