        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    adapter2 = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, android.R.id.text1, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
