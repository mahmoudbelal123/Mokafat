...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            int selected2 = R.styleable.TabLayout_tabMinWidth;
            this.mRequestedTabMinWidth = a.getDimensionPixelSize(selected2, -1);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mode == Integer.MIN_VALUE) {
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(idealHeight, View.MeasureSpec.getSize(heightMeasureSpec)), CrashUtils.ErrorDialogData.SUPPRESSED);
        } else if (mode == 0) {
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(idealHeight, CrashUtils.ErrorDialogData.SUPPRESSED);
        }
        ...
        if (getChildCount() == 1) {
            ...
            if (remeasure) {
                ...
                int childWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), CrashUtils.ErrorDialogData.SUPPRESSED);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (Math.abs(position - this.mSelectedPosition) <= 1) {
                ...
                startRight2 = this.mIndicatorRight;
                ...
                startRight2 = startRight3;
            }
            final int startLeft2 = startRight;
            if (startLeft2 == targetLeft && startRight2 == targetRight) {
                return;
            }
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.support.design.widget.TabLayout.SlidingTabStrip.1
                ...
                public void onAnimationUpdate(ValueAnimator animator2) {
                    ...
                    SlidingTabStrip.this.setIndicatorPosition(AnimationUtils.lerp(startLeft2, targetLeft, fraction), AnimationUtils.lerp(i, targetRight, fraction));
                }
            });
