...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int i2 = R.styleable.CoordinatorLayout_statusBarBackground;
    ...
    */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (widthUsed5 >= childCount2) {
                ...
                int heightUsed4 = widthUsed4;
                int width = View.resolveSizeAndState(heightUsed4, widthMeasureSpec, (-16777216) & childState5);
            ...
            if (child3.getVisibility() == 8) {
                ...
                if (lp.keyline < 0 || widthMode == 0) {
                    ...
                    heightUsed = heightUsed3;
                    int heightUsed5 = lp.gravity;
                    int keylineGravity = GravityCompat.getAbsoluteGravity(resolveKeylineGravity(heightUsed5), layoutDirection) & 7;
                    childState = childState3;
                ...
                if (b != null) {
                    ...
                    int heightUsed6 = childWidthMeasureSpec;
                    child2 = child4;
                    widthUsed2 = widthUsed;
                    childCount = childCount2;
                    int childCount3 = childHeightMeasureSpec;
                    heightMode = heightMode2;
                    if (!b.onMeasureChild(this, child4, heightUsed6, keylineWidthUsed, childCount3, 0)) {
                    }
                    View child5 = child2;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    final void onChildViewsChanged(int r20) {
        /*
