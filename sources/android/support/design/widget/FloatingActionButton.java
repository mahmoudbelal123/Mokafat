...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCustomSize = a.getDimensionPixelSize(R.styleable.FloatingActionButton_fabCustomSize, 0);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (ev.getAction() == 0 && getContentRect(this.mTouchArea) && !this.mTouchArea.contains((int) ev.getX(), (int) ev.getY())) {
            return false;
        }
