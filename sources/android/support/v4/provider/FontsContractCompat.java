...
public class FontsContractCompat {
            ...
            sBackgroundThread.postAndReply(fetcher, new SelfDestructiveThread.ReplyCallback<TypefaceResult>() { // from class: android.support.v4.provider.FontsContractCompat.3
                ...
                public void onReply(TypefaceResult typeface) {
                    synchronized (FontsContractCompat.sLock) {
                        ArrayList<SelfDestructiveThread.ReplyCallback<TypefaceResult>> replies = (ArrayList) FontsContractCompat.sPendingReplies.get(id);
                        if (replies == null) {
                            return;
                        }
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int ttcIndex, @IntRange(from = 1, to = 1000) int weight, boolean italic, int resultCode) {
