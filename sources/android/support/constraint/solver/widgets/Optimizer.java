...
public class Optimizer {
    ...
    static void analyze(int optimisationLevel, ConstraintWidget widget) {
        ...
        if (topNode.type != 4 && bottomNode.type != 4) {
            ...
            if (widget.mListDimensionBehaviors[1] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && optimizableMatchConstraint(widget, 1)) {
    ...
    */
    static boolean applyChainOptimized(android.support.constraint.solver.widgets.ConstraintWidgetContainer r46, android.support.constraint.solver.LinearSystem r47, int r48, int r49, android.support.constraint.solver.widgets.ConstraintWidget r50) {
        /*
