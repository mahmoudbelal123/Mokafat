...
public class FirebaseAppHelper {
    ...
    @KeepForSdk
    public static void addIdTokenListener(FirebaseApp app, FirebaseApp.IdTokenListener listener) {
        app.addIdTokenListener(listener);
    }

    @KeepForSdk
    public static void removeIdTokenListener(FirebaseApp app, FirebaseApp.IdTokenListener listener) {
