...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String getSpecificString() {
        ...
        StringBuilder sb = new StringBuilder(45 + String.valueOf(wakeLockName).length() + String.valueOf(strJoin).length() + String.valueOf(secondaryWakeLockName).length() + String.valueOf(hostPackage).length() + String.valueOf(codePackage).length());
        sb.append("\t");
