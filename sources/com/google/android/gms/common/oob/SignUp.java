...
public class SignUp {
    ...
    public static boolean isSignedUpBlocking(Context context, String str, String[] strArr) throws OperationCanceledException, IOException, AuthenticatorException {
