...
public class SSLCertificateSocketFactory extends SSLSocketFactory {
    ...
    private static void zza(Socket socket, int i) {
        if (socket != null) {
            try {
                ...
                StringBuilder sb2 = new StringBuilder(46 + String.valueOf(strValueOf2).length());
    ...
    private static void zza(Socket socket, PrivateKey privateKey) {
        if (socket != null) {
            try {
                ...
                String strValueOf = String.valueOf(socket.getClass());
                StringBuilder sb = new StringBuilder(42 + String.valueOf(strValueOf).length());
                sb.append(strValueOf);
                ...
                String strValueOf2 = String.valueOf(socket.getClass());
                StringBuilder sb2 = new StringBuilder(43 + String.valueOf(strValueOf2).length());
    ...
    private static void zza(Socket socket, byte[] bArr) {
        if (socket != null) {
            try {
                ...
                String strValueOf = String.valueOf(socket.getClass());
                StringBuilder sb = new StringBuilder(35 + String.valueOf(strValueOf).length());
                sb.append(strValueOf);
                ...
                String strValueOf2 = String.valueOf(socket.getClass());
                StringBuilder sb2 = new StringBuilder(36 + String.valueOf(strValueOf2).length());
    ...
    private static void zzb(Socket socket, byte[] bArr) {
        if (socket != null) {
            try {
                ...
                String strValueOf = String.valueOf(socket.getClass());
                StringBuilder sb = new StringBuilder(36 + String.valueOf(strValueOf).length());
                sb.append(strValueOf);
                ...
                String strValueOf2 = String.valueOf(socket.getClass());
                StringBuilder sb2 = new StringBuilder(37 + String.valueOf(strValueOf2).length());
    ...
    public byte[] getAlpnSelectedProtocol(Socket socket) {
        try {
            ...
            String strValueOf = String.valueOf(socket.getClass());
            StringBuilder sb = new StringBuilder(43 + String.valueOf(strValueOf).length());
            sb.append(strValueOf);
            ...
            String strValueOf2 = String.valueOf(socket.getClass());
            StringBuilder sb2 = new StringBuilder(44 + String.valueOf(strValueOf2).length());
    ...
    public void setHostname(Socket socket, String str) {
        try {
            ...
            String strValueOf = String.valueOf(socket.getClass());
            StringBuilder sb = new StringBuilder(31 + String.valueOf(strValueOf).length());
            sb.append(strValueOf);
    ...
    public void setSoWriteTimeout(Socket socket, int i) throws SocketException {
        try {
            ...
            String strValueOf2 = String.valueOf(socket.getClass());
            StringBuilder sb2 = new StringBuilder(38 + String.valueOf(strValueOf2).length());
    ...
    public void setUseSessionTickets(Socket socket, boolean z) {
        try {
            ...
            String strValueOf2 = String.valueOf(socket.getClass());
            StringBuilder sb2 = new StringBuilder(41 + String.valueOf(strValueOf2).length());
