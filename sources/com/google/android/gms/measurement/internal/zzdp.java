...
final class zzdp implements Runnable {
    ...
    zzdp(zzdo zzdoVar, boolean z, zzdn zzdnVar, zzdn zzdnVar2) {
        this.zzarx = zzdoVar;
        this.zzaru = z;
        this.zzarv = zzdnVar;
        this.zzarw = zzdnVar2;
    ...
    public final void run() {
        ...
        if ((this.zzarv != null && this.zzarv.zzarm == this.zzarw.zzarm && zzfk.zzu(this.zzarv.zzarl, this.zzarw.zzarl) && zzfk.zzu(this.zzarv.zzuw, this.zzarw.zzuw)) ? false : true) {
