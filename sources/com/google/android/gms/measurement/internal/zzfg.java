...
public final class zzfg extends zzez {
    ...
    final void zza(zzgl zzglVar, Object obj) {
    ...
    final void zza(zzgg zzggVar, Object obj) {
        Preconditions.checkNotNull(obj);
        zzggVar.zzamp = null;
        zzggVar.zzawx = null;
        zzggVar.zzauh = null;
    ...
    static zzgg zza(zzgf zzgfVar, String str) {
    ...
    static Object zzb(zzgf zzgfVar, String str) {
        zzgg zzggVarZza = zza(zzgfVar, str);
        if (zzggVarZza != null) {
            if (zzggVarZza.zzamp != null) {
                return zzggVarZza.zzamp;
            }
            if (zzggVarZza.zzawx != null) {
                return zzggVarZza.zzawx;
            }
            if (zzggVarZza.zzauh != null) {
                return zzggVarZza.zzauh;
            }
            return null;
        }
        return null;
    ...
    static zzgg[] zza(zzgg[] zzggVarArr, String str, Object obj) {
    ...
    @WorkerThread
    final boolean zze(zzad zzadVar, zzh zzhVar) {
