...
public final class zzat extends zzez {
    ...
    protected final HttpURLConnection zzb(URL url) throws IOException {
        ...
        if (this.zzamq != null && (uRLConnectionOpenConnection instanceof HttpsURLConnection)) {
            ((HttpsURLConnection) uRLConnectionOpenConnection).setSSLSocketFactory(this.zzamq);
        }
