...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    private void runWrapped() throws GlideException {
    ...
    private void runGenerators() {
        ...
        while (!this.isCancelled && this.currentGenerator != null) {
            boolean zStartNext = this.currentGenerator.startNext();
            isStarted = zStartNext;
            if (zStartNext) {
                break;
            }
    ...
    private void decodeFromRetrievedData() throws GlideException {
    ...
    <Z> Resource<Z> onResourceDecoded(DataSource dataSource, @NonNull Resource<Z> decoded) {
        ...
        if (!decoded.equals(transformed2)) {
            decoded.recycle();
        }
        ...
        ResourceEncoder resourceEncoder = encoder;
        ...
        if (!this.diskCacheStrategy.isResourceCacheable(isFromAlternateCacheKey, dataSource, encodeStrategy2)) {
            return transformed2;
        }
        ...
        LockedResource lockedResourceObtain = LockedResource.obtain(transformed2);
        this.deferredEncodeManager.init(key, resourceEncoder, lockedResourceObtain);
