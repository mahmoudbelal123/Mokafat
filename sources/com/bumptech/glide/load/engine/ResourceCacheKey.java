...
final class ResourceCacheKey implements Key {
    ...
    public int hashCode() {
        ...
        int result2 = (31 * ((31 * ((31 * result) + this.signature.hashCode())) + this.width)) + this.height;
        if (this.transformation != null) {
            result2 = (31 * result2) + this.transformation.hashCode();
        }
        return (31 * ((31 * result2) + this.decodedResourceClass.hashCode())) + this.options.hashCode();
    }
