...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    @NonNull
    private Resource<ResourceType> decodeResourceWithList(DataRewinder<DataType> rewinder, int width, int height, @NonNull Options options, List<Throwable> exceptions) throws IOException, GlideException {
