...
public class RequestBuilder<TranscodeType> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    protected RequestOptions getMutableOptions() {
        return this.defaultRequestOptions == this.requestOptions ? this.requestOptions.mo9clone() : this.requestOptions;
    }
    ...
    public RequestBuilder<TranscodeType> load2(@Nullable Object model) {
    ...
    @NonNull
    /* JADX INFO: renamed from: load */
    public RequestBuilder<TranscodeType> load2(@Nullable String string) {
    ...
    @NonNull
    /* JADX INFO: renamed from: load */
    public RequestBuilder<TranscodeType> load2(@RawRes @DrawableRes @Nullable Integer resourceId) {
    ...
    @NonNull
    /* JADX INFO: renamed from: load */
    public RequestBuilder<TranscodeType> load2(@Nullable byte[] model) {
    ...
    public RequestBuilder<TranscodeType> mo7clone() {
        try {
            ...
            result.requestOptions = result.requestOptions.mo9clone();
            result.transitionOptions = result.transitionOptions.m8clone();
            return result;
    ...
    public ViewTarget<ImageView, TranscodeType> into(@NonNull ImageView view) {
        ...
        if (!requestOptions.isTransformationSet() && requestOptions.isTransformationAllowed() && view.getScaleType() != null) {
            switch (AnonymousClass2.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
                case 1:
                    requestOptions = requestOptions.mo9clone().optionalCenterCrop();
                    break;
                case 2:
                    requestOptions = requestOptions.mo9clone().optionalCenterInside();
                    break;
                case 3:
                case 4:
                case 5:
                    requestOptions = requestOptions.mo9clone().optionalFitCenter();
                    break;
                case 6:
                    requestOptions = requestOptions.mo9clone().optionalCenterInside();
                    break;
    ...
    private Request buildRequestRecursive(Target<TranscodeType> target, @Nullable RequestListener<TranscodeType> targetListener, @Nullable RequestCoordinator parentCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int overrideWidth, int overrideHeight, RequestOptions requestOptions) {
        ...
        Request errorRequest = this.errorBuilder.buildRequestRecursive(target, targetListener, errorRequestCoordinator, this.errorBuilder.transitionOptions, this.errorBuilder.requestOptions.getPriority(), errorOverrideWidth, errorOverrideHeight, this.errorBuilder.requestOptions);
    ...
    private Request buildThumbnailRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> targetListener, @Nullable RequestCoordinator parentCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int overrideWidth, int overrideHeight, RequestOptions requestOptions) {
        ...
        if (this.thumbSizeMultiplier != null) {
            ...
            RequestOptions thumbnailOptions = requestOptions.mo9clone().sizeMultiplier(this.thumbSizeMultiplier.floatValue());
