...
public class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> implements Cloneable {
    ...
    @CheckResult
    @NonNull
    public GlideRequest<TranscodeType> encodeQuality(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 100) int value) {
        if (getMutableOptions() instanceof GlideOptions) {
    ...
    @CheckResult
    @NonNull
    public GlideRequest<TranscodeType> frame(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) long value) {
        if (getMutableOptions() instanceof GlideOptions) {
    ...
    @CheckResult
    @NonNull
    public GlideRequest<TranscodeType> timeout(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int value) {
        if (getMutableOptions() instanceof GlideOptions) {
    ...
    public GlideRequest<TranscodeType> load2(@Nullable Object o) {
    ...
    @NonNull
    /* JADX INFO: renamed from: load */
    public GlideRequest<TranscodeType> load2(@Nullable String string) {
    ...
    @NonNull
    /* JADX INFO: renamed from: load */
    public GlideRequest<TranscodeType> load2(@RawRes @DrawableRes @Nullable Integer id) {
    ...
    @NonNull
    /* JADX INFO: renamed from: load */
    public GlideRequest<TranscodeType> load2(@Nullable byte[] bytes) {
