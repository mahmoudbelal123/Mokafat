...
public final class OnSubscribeJoin<TLeft, TRight, TLeftDuration, TRightDuration, R> implements Observable.OnSubscribe<R> {
    ...
    final class ResultSink extends HashMap<Integer, TLeft> {
        ...
        final class LeftSubscriber extends Subscriber<TLeft> {
            ...
            public void onNext(TLeft tleft) throws Throwable {
                synchronized (ResultSink.this) {
                    int i = 0;
                    try {
                        ResultSink resultSink = ResultSink.this;
                        int i2 = resultSink.leftId;
                        resultSink.leftId = i2 + 1;
                        try {
                            ResultSink.this.leftMap().put(Integer.valueOf(i2), tleft);
                            i = ResultSink.this.rightId;
                            try {
        ...
        final class RightSubscriber extends Subscriber<TRight> {
            ...
            @Override // rx.Observer
            public void onNext(TRight tright) throws Throwable {
                synchronized (ResultSink.this) {
                    int i = 0;
                    try {
                        ResultSink resultSink = ResultSink.this;
